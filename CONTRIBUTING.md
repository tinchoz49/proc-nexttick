...
Fork the project [on GitHub](https://github.com/tinchoz49/proc-nexttick) and check out your copy locally.

```bash
$ git clone git@github.com:username/proc-nexttick.git
$ cd proc-nexttick
$ npm install
$ git remote add upstream git://github.com/tinchoz49/proc-nexttick.git
```
